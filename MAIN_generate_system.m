...
x1=zeros(size(t)); x1(1) = rand()*1;
x2=zeros(size(t)); x2(1) = rand()*1;
x3=zeros(size(t)); x3(1) = rand()*1;
y1=zeros(size(t)); y1(1) = rand()*1;
y2=zeros(size(t)); y2(1) = rand()*1;
y3=zeros(size(t)); y3(1) = rand()*1;
z1=zeros(size(t)); z1(1) = rand()*1;
z2=zeros(size(t)); z2(1) = rand()*1;
z3=zeros(size(t)); z3(1) = rand()*1;
...
for i = 2:Nt
    ...
    y2(i) = y2(i-1) + (r*y1(i-1) - y2(i-1) - y1(i-1)*y3(i-1) + mi12*x2(i-1)^2+mi32*z3(i-1)^2)*dt;
